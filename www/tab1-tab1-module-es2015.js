...
let Tab1Page = class Tab1Page {
    ...
    submit() {
        if (this.message != "" && this.message != undefined) {
            ...
            //"url": "url1",
            this.httpClient.post("https://mohammed.red/reportRumor", { "message": this.message, "language": "ar" })
                .subscribe((data) => {
    ...
    uploadPWA() {
        ...
        if (fileList && fileList.length > 0) {
            this.firstFileToBase64(fileList[0]).then((result) => {
                ...
                this.httpClient.post("https://mohammed.red/reportRumor", { "uri": result, "language": "ar" })
                    .subscribe((data) => {
                    console.log("POST Request is successful ", data);
                    this.data.push({ "text": data.message, isAKD: true });
                }, error => { console.log("Error", error); });
...
], Tab1Page.prototype, "pwaphoto", void 0);
